      ...
      >
        ...
        >
          ...
          <div className="list-group">
            ...
            <Link
              to="/finance-dashboard/balance-sheet"
              className="list-group-item list-group-item-action text-dark"
            >
        ...
        <div className="flex-grow-1 p-5">
          <Routes>
            ...
            <Route
              path="/finance-dashboard/add-transaction"
              element={<AddTransaction />}
            />
            <Route
              path="/finance-dashboard/payment-portal"
              element={<PaymentPortal />}
            />
            <Route
              path="/finance-dashboard/petty-cash"
            ...
            />
            <Route
              path="/balance-sheets/dashboard"
              element={<FinanceDashboard />}
            />
            <Route
              path="/finance-dashboard/balance-sheet/:id"
              element={<BalanceSheetDetail />}
            />
            <Route
              path="/finance-dashboard/balance-sheet/update/:id"
              element={<BalanceSheetUpdate />}
            />

            {/* Other Dashboards */}
            <Route
              path="/employee-dashboard"
              element={<h2>Employee Dashboard (Coming Soon)</h2>}
            />
            <Route
            ...
            <Route
              ...
              element={<h2>Repair Dashboard (Coming Soon)</h2>}
            />
            <Route
              path="/inventory-dashboard"
              element={<h2>Inventory Dashboard (Coming Soon)</h2>}
            />
            <Route
              path="/appointment-dashboard"
              element={<h2>Service Appointment Dashboard (Coming Soon)</h2>}
            />
